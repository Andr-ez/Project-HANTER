...
// Vista previa de certificados para el administrador:
// elige entre ver como admin (103-A) o como usuario (101).
// ==============================
function CertificadosAdmin() {
  ...
  // ==============================
  useEffect(() => {
    document.title = "CERTIFICADOS — ADMIN";
    ...
    const cargarDatos = async () => {
      try {
        ...
        // Si el usuario NO es admin/supervisor, redirigir a la vista normal
        ...
        setBotones([
          ...
          { id: 2, nombre: "CERTIFICADOS",   link: "/101-A", posicion: ["header", "sidebar"], hijos: [] },
    ...
    <div className="certificados-page">
      ...
      <nav className="nav-horizontal">
        {cargando ? (
          ...
          botonesHeader.map(btn => (
            <button
              key={btn.id}
              className={btn.link === "/101-A" ? "active" : ""}
      ...
      <main className="main-content">
        ...
        <div className="cert-botones">
          ...
          {/* Ver como administrador → revisión y aprobación de certificados */}
          <button
            className="cert-btn"
            onClick={() => navigate("/103-A")}
          >
            VER COMO<br />ADMINISTRADOR
          </button>

          {/* Ver como usuario → vista de empleado con sus certificados */}
          <button
            className="cert-btn"
      ...
      {/* Decoraciones */}
      <div className="cGDecor-1" />
      <div className="cGDecor-2" />
