    ...
    return (
      <div className="registro-page">
        ...
        <div className="exito-container">
          ...
          <h2 className="exito-titulo">¡CUENTA CREADA<br />EXITOSAMENTE!</h2>

          <p className="exito-subtitulo">
            Tu usuario <strong>{formData.username}</strong> ha sido registrado correctamente.
          </p>

          <button
            className="btnRegistro exito-btn"
